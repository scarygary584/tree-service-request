    ...
    body: () => `
      ...
      <section class="section">
        <div class="wrap">
          ...
          <figure class="mid-page-photo">
            <img src="/assets/fallen-tree-cleanup.svg" width="1536" height="1024" alt="A professional tree-service crew using equipment to clear a fallen tree from a residential yard" loading="lazy">
            <figcaption>Fallen trees and storm debris may require specialized equipment and a controlled work area.</figcaption>
          </figure>
        </div>
      </section>
      <section class="section band">
...
write("photo-styles.css", photoCss);
write("script.js", js);
